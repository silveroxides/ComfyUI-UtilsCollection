    ...
    def define_schema(cls):
        return io.Schema(
            ...
            inputs=[
                ...
                io.Float.Input("overlap_threshold", display_name="Minimum similarity (%)", default=88.0, min=0.0, max=100.0, step=0.1, tooltip="Average similarity required before matching frames are removed. Higher values require a closer match; lower values may remove frames that only look similar."),
